...
```powershell
mvn archetype:generate -DgroupId=com.example -DartifactId=kerberos-sspi-reader \
...
mvn package               # creates target/kerberos-sspi-reader-1.0-SNAPSHOT.jar
...
```powershell
java -jar target/kerberos-sspi-reader-1.0-SNAPSHOT.jar
# or with a service ticket request:
java -jar target/kerberos-sspi-reader-1.0-SNAPSHOT.jar "HTTP/yourserver.domain.com"
```